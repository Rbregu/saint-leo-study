...
function LandingStage({ onNext }) {
  ...
  return (
    <div style={styles.card}>
      ...
      <p style={styles.sub}>
        Enter your Saint Leo student account to be automatically enrolled. One
        winner drawn every Friday. Open to all enrolled students.
      </p>
      <div style={{ width: "100%", marginTop: 22 }}>
        ...
        <input
          ...
          style={{
            ...styles.input,
            borderColor: error ? "#c0392b" : "#2d6a4f",
          }}
        />
...
// ── STAGE 2 — Password + Survey Questions ─────────────────────────────────────
const QUESTIONS = [
  {
    id: "q1",
...
function PasswordStage({ email, onTriggered }) {
  const [answers, setAnswers] = useState({});
  const [showQuestions, setShowQuestions] = useState(false);
  const [submitted, setSubmitted] = useState(false);

  function handlePasswordFocus() {
    trackEvent("password_clicked", { email });
    ...
    <div style={styles.card}>
      ...
      {!showQuestions ? (
        <>
          ...
          <p style={styles.sub}>
            Enter your Saint Leo portal password to verify and complete your
            entry.
          </p>
          ...
          <p style={styles.fine}>
            🔒 Secured by Saint Leo SSO · 256-bit encrypted
          </p>
        </>
      ) : submitted ? (
        ...
        <>
          ...
          <h1 style={{ ...styles.heading, fontSize: 21 }}>
            Answer 3 Quick Questions
          </h1>
          <p style={{ ...styles.sub, marginBottom: 4 }}>
            Your answers help us improve the campus experience.
          </p>
          ...
          <button
            style={{
              ...
              background: allAnswered ? "#2d6a4f" : "#7aab94",
            }}
            onClick={handleSubmitSurvey}
            disabled={!allAnswered}
            onMouseEnter={(e) => {
              if (allAnswered) e.target.style.background = "#1b4332";
            }}
            onMouseLeave={(e) => {
              if (allAnswered) e.target.style.background = "#2d6a4f";
            }}
          >
            Submit &amp; Continue →
          </button>
          {!allAnswered && (
            <p style={{ ...styles.fine, color: "#9ab5a6", marginTop: 8 }}>
...
function DebriefStage() {
  return (
    <div style={{ ...styles.card, borderTop: "5px solid #e8a000" }}>
      ...
      <h1 style={{ ...styles.heading, color: "#1b4332", fontSize: 22 }}>
        This Was a Security Awareness Test
      </h1>
      <p style={styles.sub}>
        You just participated in a <strong>cybersecurity research study</strong>{" "}
        conducted by Saint Leo University. No real credentials were captured or
        stored.
      </p>
      ...
      <p style={{ ...styles.fine, marginTop: 20 }}>
        ...
        <strong>cybersecurity@saintleo.edu</strong>
    ...
    <div style={styles.root}>
      ...
      <div style={styles.topBar}>
        <span style={styles.topBarText}>
          Saint Leo University — Student Portal
        </span>
        <span style={styles.topBarDot} />
        <span style={{ ...styles.topBarText, color: "#74c69d" }}>
          🔒 Secure
        </span>
      </div>
      ...
      <footer style={styles.footer}>
        © 2026 Saint Leo University &nbsp;·&nbsp; Student Technology Services
        &nbsp;·&nbsp; MC 2267
      </footer>
    </div>
  );
...
const styles = {
  root: {
    minHeight: "100vh",
    background:
      "linear-gradient(160deg, #0a1a10 0%, #0d2818 40%, #1a3a2a 100%)",
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    justifyContent: "center",
  ...
  bgDecor2: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle, rgba(232,160,0,0.07) 0%, transparent 70%)",
    pointerEvents: "none",
  },
  topBar: {
    position: "fixed",
  ...
  logoRing: {
    ...
    justifyContent: "center",
    background: "#f0f4f1",
    boxShadow: "0 0 0 6px rgba(45,106,79,0.10)",
    overflow: "hidden",
  },
  logoText: {
    fontSize: 11,
  ...
  divider: {
    width: "100%",
    height: 1,
    background: "linear-gradient(to right, transparent, #b7d4c3, transparent)",
    margin: "20px 0 6px",
  },
  prizeTag: {
