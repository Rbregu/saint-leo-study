...
const T = {
  en: {
    ...
    contact:      "Questions? Contact the research team at gina.brierley@saintleo.edu · ramadan.bregu@saintleo.edu · edward.santiago@saintleo.edu",
    footer:       "© 2026 Saint Leo University",
